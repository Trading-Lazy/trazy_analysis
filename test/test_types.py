...
def test_aggregate():
    ...
    assert aggregated_candle_dataframe.get_candle(0) == Candle(asset=Asset(symbol=SYMBOL, exchange="IEX"), open=323.69,
                                                               high=324.21, low=323.67, close=324.10, volume=1200,
                                                               timestamp=datetime.strptime("2020-05-07 14:25:00+0000",
                                                                                           "%Y-%m-%d %H:%M:%S%z"))
    assert aggregated_candle_dataframe.get_candle(1) == Candle(asset=Asset(symbol=SYMBOL, exchange="IEX"), open=324.10,
                                                               high=324.10, low=323.97, close=324.03, volume=400,
                                                               timestamp=datetime.strptime("2020-05-07 14:30:00+0000",
                                                                                           "%Y-%m-%d %H:%M:%S%z"))
    assert aggregated_candle_dataframe.get_candle(2) == Candle(asset=Asset(symbol=SYMBOL, exchange="IEX"), open=323.93,
                                                               high=323.95, low=323.83, close=323.88, volume=300,
                                                               timestamp=datetime.strptime("2020-05-07 14:35:00+0000",
                                                                                           "%Y-%m-%d %H:%M:%S%z"))
