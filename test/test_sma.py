...
def test_sma_stream_handle_data_source_is_rolling_window_stream():
...
def test_sma_stream_handle_data_source_is_rolling_window_stream_with_lower_period():
...
def test_sma_stream_handle_data_source_is_filled_rolling_window_stream():
