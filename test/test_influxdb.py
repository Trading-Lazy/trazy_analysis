...
def test_get_candle_by_identifier():
    ...
    INFLUXDB_STORAGE.add_candle(CANDLE1)
    candle: Candle = INFLUXDB_STORAGE.get_candle_by_identifier(CANDLE1.asset, CANDLE1.timestamp)
...
def test_get_candles_in_range():
    ...
    candles: List[Candle] = INFLUXDB_STORAGE.get_candles_in_range(CANDLE1.asset,
...
def test_get_signal_by_identifier():
    ...
    INFLUXDB_STORAGE.add_signal(SIGNAL1)
    signal: Signal = INFLUXDB_STORAGE.get_signal_by_identifier(SIGNAL1.asset, SIGNAL1.strategy,
