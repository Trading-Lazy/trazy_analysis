...
def test_generate_ticker_url():
    ...
    IexCloudApiAccess.API_TOKEN = "abcde"
    expected_url = (
    ...
    assert expected_url == IexCloudApiAccess.generate_ticker_url(ticker, period)
...
def test_parse_get_tickers_response():
    ...
    assert (
        IexCloudApiAccess.parse_get_tickers_response(tickers_response)
...
def test_ticker_data_is_none():
    data = ""
    assert IexCloudApiAccess.ticker_data_is_none(data)
...
def test_ticker_data_to_dataframe():
    ...
    df = IexCloudApiAccess.ticker_data_to_dataframe(data)
