...
from trazy_analysis.file_storage.meganz_file_storage import MegaExtended
...
@patch(
    "trazy_analysis.file_storage.meganz_file_storage.MegaExtended.create_folder_helper"
)
...
@patch("trazy_analysis.file_storage.meganz_file_storage.MegaExtended.find")
@patch("trazy_analysis.file_storage.meganz_file_storage.MegaExtended.upload_helper")
...
@patch("trazy_analysis.file_storage.meganz_file_storage.MegaExtended.destroy_helper")
...
@patch(
    "trazy_analysis.file_storage.meganz_file_storage.MegaExtended.get_file_content_helper"
)
