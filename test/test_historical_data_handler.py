...
def test_request_ticker_data_for_period_tiingo(
    ...
    ticker_data = (
        "date,open,high,low,close,volume\n"
        "2020-06-18 15:59:00-04:00,354.28,354.96,353.96,354.78,2324\n"
        "2020-06-18 16:00:00-04:00,354.92,355.32,354.09,354.09,1123\n"
        "2020-06-19 09:30:00-04:00,354.25,354.59,354.14,354.59,2613\n"
    )
