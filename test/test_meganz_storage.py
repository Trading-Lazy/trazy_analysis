...
from historical_data.common import PATH_SEPARATOR
from historical_data.meganz_storage import MegaExtended, MegaNzStorage

MEGA_NZ_STORAGE = MegaNzStorage()
FILE_CONTENT = "YOLO"
FILE_ID = "dFyGGcKD"
FILE_NAME = "file"
DIR1 = "dir1"
...
@patch("historical_data.meganz_storage.MegaExtended.get_files_in_node")
@patch("historical_data.meganz_storage.MegaExtended.find")
...
@patch("historical_data.meganz_storage.MegaExtended.create_folder")
...
@patch("historical_data.meganz_storage.MegaExtended.upload")
@patch("historical_data.meganz_storage.MegaExtended.find")
@patch("historical_data.meganz_storage.MegaExtended.destroy")
@patch("historical_data.meganz_storage.MegaNzStorage.exists")
...
@patch("historical_data.meganz_storage.MegaExtended.get_file_content")
def test_get_file_content(get_file_content_mocked):
    ...
    get_file_content_mocked.assert_has_calls(
